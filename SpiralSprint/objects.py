...
# A class ball whcih takes initial pos, size, angle, window, and shape
class Balls(pygame.sprite.Sprite):
    ...
    # Update the the balls angle [basic math try in rough sheet]
    ...
    def reset(self):
        ...
        self.pos_list = []
        self.step = 0
# Coin takes x & y coord of screen, size, and diffrential angle
...
# Tiles that needs to be blocked takes in x & y coords, angle, type and window ssize
